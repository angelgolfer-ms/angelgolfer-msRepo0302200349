...
## Request body
In the request body, supply a JSON representation for the [windowsStoreApp](../resources/intune_apps_windowsstoreapp.md) object.

The following table shows the properties that are required when you create the [windowsStoreApp](../resources/intune_apps_windowsstoreapp.md).
